...
export default function Contact() {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="relative min-h-[60vh] flex flex-col justify-center items-center text-center bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 text-white overflow-hidden px-4 sm:px-6">
        ...
        <div className="max-w-4xl mx-auto z-10">
          ...
          <motion.p
            ...
            className="text-indigo-100 text-lg sm:text-xl max-w-3xl mx-auto leading-relaxed"
          >
            ...
            {[
              {
                ...
                contact: "support@smartreview.com",
                icon: (
                ...
                link: "mailto:support@smartreview.com"
              },
              {
                title: "Call Us",
              ...
              >
                ...
                <p className="text-gray-600 mb-3 text-sm">{option.desc}</p>
                <p className="text-indigo-600 font-semibold">{option.contact}</p>
              </motion.a>
            ))}
          </div>
        </div>
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full inline-flex items-center justify-center gap-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-8 py-4 rounded-full font-bold text-lg hover:from-indigo-700 hover:to-purple-700 transition-all shadow-lg hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
                    <>
            ...
            >
              ...
              <div className="bg-gradient-to-br from-indigo-50 to-purple-50 p-8 rounded-2xl border border-indigo-100">
                ...
                <div className="space-y-6">
                  <div>
                    <h4 className="font-bold text-gray-800 mb-2">India (Headquarters)</h4>
                    <p className="text-gray-600 leading-relaxed">
                      Tower A, 5th Floor<br />
                      Tech Park, Bhopal<br />
                      Madhya Pradesh 462001<br />
                      India
                    </p>
                  </div>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-8 rounded-2xl border border-purple-100">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-gray-800">Quick Answers</h3>
                </div>
                ...
                <div className="space-y-4">
                  <a href="#" className="flex items-start gap-3 group">
                    ...
                    <span className="text-gray-700 group-hover:text-purple-600 transition">How does the review filtering work?</span>
                  </a>
                  <a href="#" className="flex items-start gap-3 group">
                    <svg className="w-5 h-5 text-purple-600 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd"/>
                    </svg>
                    <span className="text-gray-700 group-hover:text-purple-600 transition">What are your pricing plans?</span>
                  </a>
                  <a href="#" className="flex items-start gap-3 group">
                    <svg className="w-5 h-5 text-purple-600 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd"/>
                    </svg>
                    <span className="text-gray-700 group-hover:text-purple-600 transition">Can I manage multiple locations?</span>
                  </a>
                  <a href="#" className="flex items-start gap-3 group">
                    <svg className="w-5 h-5 text-purple-600 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd"/>
                    </svg>
                    <span className="text-gray-700 group-hover:text-purple-600 transition">Is there a free trial available?</span>
                  </a>
                </div>

                <div className="mt-6 pt-6 border-t border-purple-200">
                  <a href="#" className="text-purple-600 font-semibold hover:text-purple-700 transition inline-flex items-center gap-2">
                    View all FAQs
          ...
          <div className="flex justify-center gap-4">
            {[
              ...
              <motion.a
                ...
                viewport={{ once: true }}
                className={`w-12 h-12 bg-gray-800 ${social.color} text-white rounded-full flex items-center justify-center transition-all hover:scale-110 shadow-lg`}
              >
